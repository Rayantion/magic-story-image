const I18N = (() => {
  const strings = {
    en: {
      ...
      "gallery.throttled": "Pollinations is busy",
      "gallery.throttled_hint": "Tap to retry — free tier limit reached.",
      "gallery.retry": "Retry",
      ...
      "nav.acdorm": "Jieren Ac Dorm & Bus Schedule",
    ...
    "zh-TW": {
      ...
      "gallery.throttled": "Pollinations 忙碌中",
      "gallery.throttled_hint": "點擊重試 — 免費額度已達上限。",
      "gallery.retry": "重試",
      "gallery.drawn": "你的畫",
